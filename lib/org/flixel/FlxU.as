package org.flixel
{
	...
	public class FlxU
	{
		 ...
		 * The last quad tree you generated will be stored here for reference or whatever.
		 */
		static private var urlLoader:URLLoader;
		 ...
		 */
		public static function loadEmbeddedXML(xml:Class, callback:Function = null):XML
		{
		 ...
		 */
		public static function loadExternalXML(url:String, onComplete:Function, onProgress:Function = null):void
		{
			urlLoader = new URLLoader(new URLRequest(url));
			
			urlLoader.addEventListener(Event.COMPLETE, function complete(e:Event):void
			{
				onComplete(XML(e.target.data));
			});
			urlLoader.addEventListener(IOErrorEvent.IO_ERROR, function ioerror(e:IOErrorEvent):void
			{
				throw new Error("ERROR: The specified XML file''" + url + "'' could not be found. Load aborted.");
			});
			if (onProgress != null)
			{
				urlLoader.addEventListener(ProgressEvent.PROGRESS, function progress(e:ProgressEvent):void
				{
