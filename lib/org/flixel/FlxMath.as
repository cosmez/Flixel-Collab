...
package org.flixel 
{
        ...
        public class FlxMath
        {
				...
				// Normalizes the vector defined by the params and returns the result as an FlxPoint
				public static function normalize(dx:Number, dy:Number):FlxPoint
				{
					var len:Number = vectorLength(dx, dy);
					return new FlxPoint(x / len, y / len);
				}
